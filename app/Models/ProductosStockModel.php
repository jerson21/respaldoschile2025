<?php 
	...
	class ProductosStockModel extends Mysql
	{
		...
		public function selectProductos(){ // SE MODIFICO EL WHERE STATUS INACTIVO
			$sql = "SELECT p.idproducto,
					...
					ON p.categoriaid = c.idcategoria Where tipo_prod = 1 ORDER BY p.status asc";
					$request = $this->select_all($sql);
			return $request;
		}	

		public function insertProducto(string $nombre, string $descripcion, string $codigo, int $categoriaid, string $precio, string $precio_normal, int $stock, string $ruta, int $status, int $tipo_prod){
			$this->strNombre = $nombre;
			$this->strDescripcion = $descripcion;
			$this->intCodigo = $codigo;
			$this->intCategoriaId = "8"; //Categoria 8 es de promociones
			$this->strPrecio = $precio;
			$this->strPrecioNormal = $precio_normal;
			$this->intStock = $stock;
			$this->strRuta = $ruta;
		...
		public function updatePrecioProducto(int $idproducto,string $tamano,string $precio, string $precio_normal){
			$this->idproducto = $idproducto;
			$this->precio = $precio;	
			$this->tamano = $tamano;	
			$return = 0;
		...
		public function updateProducto(int $idproducto, string $nombre, string $descripcion, string $codigo, int $categoriaid, string $precio,string $precio_normal, int $stock, string $ruta, int $status){
