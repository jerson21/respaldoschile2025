<?php 
	class ProductosStock extends Controllers{
		...
		public function ProductosStock()
		{
			...
			$data['page_tag'] = "Productos stock";
			$data['page_title'] = "PRODUCTOS ";
			$data['page_name'] = "productos";
			$data['page_functions_js'] = "functions_productosStock.js";
	...
	// Obtener los productos
			...
			if($_SESSION['permisosMod']['r']){
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					if($_SESSION['permisosMod']['u']){
						$btnEdit = '<button class="btn btn-primary  btn-sm" onClick="fntEditInfoStock(this,'.$arrData[$i]['idproducto'].')" title="Editar productos"><i class="fas fa-pencil-alt"></i></button>';
					}
		...
		public function setProducto(){
			if($_POST){
				if(empty($_POST['txtNombre']) || empty($_POST['txtCodigo']) || empty($_POST['listStatus']) )
				{
					...
					$strPrecionormal = strClean($_POST['txtPrecio_normal']);
					 
					
					
				// Si es un producto con precio único
				$precio_unico = isset($_POST['precio_unico']) ? 1 : 0;	
