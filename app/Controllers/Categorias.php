<?php
	class Categorias extends Controllers{
		...
		public function getSelectCategorias(){
			...
			echo '<option value="">Seleccionar</option>'.$htmlOptions;
			die();	
		}
			...
			if(count($arrData) > 0 ){
				for ($i=0; $i < count($arrData); $i++) { 
					if($arrData[$i]['estado'] == 1 ){
						...
						$htmlOptions .= '<input type="checkbox" id="checkMaterial" name="checkMaterial[]" value="'.$arrData[$i]['material'].' ">'.$arrData[$i]['material'].'<br>';
