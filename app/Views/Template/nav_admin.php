    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li>
            <a class="app-menu__item" href="<?= base_url()."tienda"; ?>" target="_blank">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="<?= base_url(); ?>/productosStock"><i class="icon fa fa-circle-o"></i> Productos Stock</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][4]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/banners"><i class="icon fa fa-circle-o"></i> Banner</a></li>
                <?php } ?>
