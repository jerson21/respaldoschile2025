  ...
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Nuevo Producto en stock</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
            <form id="formProductosStock" name="formProductosStock" class="form-horizontal">
              <input type="hidden" id="idProducto" name="idProducto" value="">
              <p class="text-primary">Los campos con asterisco (<span class="required">*</span>) son obligatorios.</p>
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                      <label class="control-label">Nombre Producto stock <span class="required">*</span></label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label">Código sku<span class="required">*</span></label>
                        <input class="form-control" id="txtCodigo" name="txtCodigo" type="text" placeholder="Código de barra" required="" value="<?php
  $d=mt_rand(111111,999999);
  echo $d ;
?>">
                        <br>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="control-label">Precio Normal <span class="required">*</span></label>
                            <input class="form-control" id="txtPrecio_normal" name="txtPrecio_normal" type="text" >
                        </div>
                       
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="control-label">Precio en Promoción <span class="required">*</span></label>
