...
<body>
	<div>
		...
		<table>
			<tr>
				<td width="33.33%">
					<img class="logo" src="https://tienda2.respaldoschile.cl/Assets/tienda/images/icons/logo-01.png" alt="Logo">
				</td>
				<td width="33.33%">
					<div class="text-center">
						<h4><strong>SISTEMA VENTAS ABELOSH</strong></h4>
						<p>
							Avenida las américas Zona 13, Guatemala <br>
				...
				<td width="33.33%">
					<div class="text-right">
						<p>
							No. Orden: <strong>00001</strong><br>
                            Fecha: 20/01/2019 <br>
                            Método Pago: PayPal <br>
                            Transacción: 7898798799
						</p>
					</div>
				</td>				
			</tr>
		...
		<table>
		    ...
		    <tr>
		    	...
		    	<td>Avenida las Américas Guatemala</td>
		    </tr>
		</table>
		<table>
