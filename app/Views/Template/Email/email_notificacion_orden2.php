...
<body>
	<div>
		<br>
		<p class="text-center">Se ha generado una orden en RespaldosChile, a continuación encontrarás los detalles.</p>
		<br>
		<hr>
		<br>
		<table>
			<tr>
				<td width="33.33%">
					<img class="logo" src="https://tienda2.respaldoschile.cl/Assets/tienda/images/logo2.png" alt="Logo">
				</td>
				<td width="33.33%">
		...
		<table>
		  ...
		  <tfoot>
		  		...
		  		<tr>
		  			<th colspan="6" class="text-right">Envío:</th>
		...
		<div class="text-center">
			<p>Si tienes preguntas sobre tu pedido, <br> Puedes ponerte en contacto con nosotros vía correo electronico o whatsapp.</p>
