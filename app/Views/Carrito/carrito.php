			...
			<div class="row">
							...
							<?php 
							 ...
							 ?>
								...
								<tr class="table_row <?= $idProducto ?>">
									...
									<td class="column-2"><?= $producto['producto'] ?><br>
									<span style="font-size:10pt;"> <?php if($producto['tamano'] = "undefined"){ echo "Producto en promoción";} ?></span> <br><span style="font-size:10pt;">	<?php if($producto['tipo_tela'] != "undefined"){ echo $producto['tipo_tela'];} ?>	<?php if($producto['color'] != "undefined"){ echo $producto['color'];}  ?></span></td>
									<td class="column-3"><?= SMONEY.number_format($producto['precio']); ?></td>
									<td  class="column-4">
										<?= $producto['cantidad'] ?>
									</td>
									<td class="column-5"><?= SMONEY.number_format($totalProducto, 0) ?></td>
								</tr>
							<?php } ?>
				...
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							Costos de envío serán reflejados en la proxima pagina.
						</div>
