...
<div id="divMetodoPago">
						...
						<div>	<br>
							...
							<table style="text-align:center; " >
									<th></th>
									<th><input type="text" id="cod_descuento" name="cod_descuento" placeholder="Ingrese codigo de descuento"  class="form-control" style="width:90%;"></th>
						...
						<div class="size-209">
							...
							<span class="mtext-110 cl2" style="font-family:'Roboto';">
								<table>
									<th>$</th>
									<th>
								<span id="totaal" data-value="<?php echo $subtotal+$costoenvio ?>"><?php echo $subtotal+$costoenvio ?></div>
