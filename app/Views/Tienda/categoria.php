			...
			if(!empty($arrProductos)){
			 ...
			 ?>
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					</div><span class="stext-107" style="background:#C6C6C6;color:white;padding:2px;border-radius: 5px; padding-left: 5px;padding-right: 5px;">$ Precios al ingresar</span>
				</div>
			<?php 
				}
			}else{
