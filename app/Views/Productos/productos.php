            ...
            <h1><i class="fas fa-box"></i> <?= $data['page_title'] ?>
              <?php if($_SESSION['permisosMod']['w']){ ?>
                <button class="btn btn-primary" type="button" onclick="openModal();" ><i class="fas fa-plus-circle"></i> Nuevo Producto</button>
                 <button class="btn btn-info" type="button" onclick="openModal('modalFormProductose');" ><i class="fas fa-plus-circle"></i>Nuevo Producto Stock</button>
              <?php } ?> 
            </h1>
        </div>
