  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo d-flex align-items-center">
        <img src="old_tienda/assets/img/logo.png" alt="">
...
if($contador == 0){
  ...
  echo "<script>window.history.back(alert('No existen datos con su rut, Puede demorar hasta 1 dia en que se ingrese el pedido.'));</script>"; exit;
}


  $sql = "SELECT * FROM pedidos where rut_cliente = '$rut' ORDER BY fecha_ingreso DESC";
...
?>
  <label>Fecha Posible de entrega <br> <b> Es posible que sea modificada, recibirá un mensaje por whatsapp con la fecha exacta.</b></label> <input type="text" class="form-control" value="<?php echo $fecha; ?>" readonly="">
</div>
...
$meses_ES = array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
  ...
  <script src="old_tienda/assets/js/main.js"></script>
