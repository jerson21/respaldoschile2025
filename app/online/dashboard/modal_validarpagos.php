                            ...
                            <div style="background-color:white; padding: 10px; border-radius:5px; ">
                                <div class="container">
                                    ...
                                    <div style=" display: flex; justify-content: flex-start">
                                       ...
                                       <?php if ($_SESSION["privilegios"] >= 21) { ?> <button type="button" id="btnCartola" class="btn btn-info btn-sm" alt="Robot para buscar Cartola" style="margin-left: auto;" onclick="solicitarCartola()">Solicitar Cartola</button>
...
<form id="searchForm">
    <div class="col-lg-6" style="display: flex; align-items: end; gap: 10px;">
        ...
        <div class="form-group" style="flex-grow: 1;">
        <img width="90" src="img/robot.gif">
            </div>
                                                ...
                                                contenedor.innerHTML = `
                                                    <div style="background-color:white; padding: 10px; border-radius:5px;">
                                                        ...
                                                        <div id="paymentOptions" class="form-group">
                                                            ...
                                                            <img src="img/transbank.png" id="transbankOption" style="cursor:pointer;" width="80" title="Pago Transbank">
    ...
    <div class="col-md-4 form-group">
        ...
        `;
                                            ...
                                            document.getElementById('addPaymentButton').addEventListener('click', function() {
                                                ...
                                                fetch(`rbot/anadirpago.php?${params.toString()}`, {
                                                        method: 'GET',
                                                    })
                                                    .then(response => {
                                                        if (response.ok) {
                        ...
                        <td><button type="button" onclick="asociarPago(${pago.id}, event, '${pago.monto.replace(/'/g, "\\'")}', '${pago.banco}', '${pago.rut}', '${pago.nombre}')" class="btn btn-primary btn-sm">Asociar</button>
                                    ...
                                    function asociarPago(idPago, event, monto, banco, rut, nombre) {
                                        ...
                                        $.ajax({
                                            url: 'rbot/buscarPagos.php', // Asegúrate de que este endpoint está correctamente implementado para manejar esta solicitud
                                            type: 'GET',
                                            data: {
                                                criterio: "pagados",
                                                id_cartola: idPago,
                        ...
                        <td>${pago.monto}</td>
                        <td>${pago.detalle}</td>
                        <td><button type="button" onclick="desasociarPago(this, ${pago.id_mostrar})" class="btn btn-danger btn-sm">X</button></td>
...
function solicitarPorMes() {
  Swal.fire({
    ...
    if (result.isConfirmed && result.value) {
      ...
      fetch('rbot/obtener_cartola_mes_curl.php', {
        method: 'POST',
        headers: {
