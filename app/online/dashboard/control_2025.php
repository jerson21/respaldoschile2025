...
<head>
    ...
    <link rel="stylesheet" src="vistas/extras.css"> 
      ...
      <?php echo getMinifiedHeaderEstilos(); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                        <button class="btn btn-success ms-2" id="btn-gestionar-empleados">
...
<div class="modal fade" id="modalConfigPresupuesto" tabindex="-1" aria-labelledby="modalConfigPresupuestoLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalConfigPresupuestoLabel">Configurar Presupuesto</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formPresupuesto">
                    <div class="mb-3">
                        <label for="anio_presupuesto" class="form-label">Año</label>
                        <select class="form-select" id="anio_presupuesto" name="anio">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" id="btnGuardarPresupuesto">Guardar Cambios</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modalGestionEmpleados" tabindex="-1" aria-labelledby="modalGestionEmpleadosLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalGestionEmpleadosLabel">Gestión de Empleados</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3 d-flex justify-content-end">
                    <button class="btn btn-success" id="btn-nuevo-empleado">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="tabla-empleados">
                        ...
                        <tbody>
                            <!-- Aquí se cargarán los empleados desde JavaScript -->
                            <tr>
                ...
                <form id="formEmpleado">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="apellido_empleado" name="apellido" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="id_departamento" name="id_departamento" required>
                                ...
                                <!-- Aquí se cargarán los departamentos desde JavaScript -->
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="cargo_empleado" class="form-label">Cargo</label>
                            <input type="text" class="form-control" id="cargo_empleado" name="cargo" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <label for="sueldo_base_empleado" class="form-label">Sueldo Base</label>
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" class="form-control" id="sueldo_base_empleado" name="sueldo_base" step="0.01" min="0" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="email_empleado" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email_empleado" name="email">
                        </div>
                        <div class="col-md-6">
                            <label for="telefono_empleado" class="form-label">Teléfono</label>
                            <input type="text" class="form-control" id="telefono_empleado" name="telefono">
                        </div>
                    </div>
                    
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="activo_empleado" name="activo" value="1" checked>
                            <label class="form-check-label" for="activo_empleado">
                                Empleado Activo
                            </label>
                        </div>
                    </div>
...
<div class="modal fade" id="modalConfirmDeleteProducto" tabindex="-1" aria-labelledby="modalConfirmDeleteProductoLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalConfirmDeleteProductoLabel">Confirmar Eliminación</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>¿Está seguro que desea eliminar este producto?</p>
                <p class="text-danger">Esta acción no se puede deshacer.</p>
                <input type="hidden" id="id_eliminar_producto">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-danger" id="btnConfirmDeleteProducto">Eliminar</button>
            </div>
        </div>
    </div>
</div>
