...
<form  name="formular" id="formular" class="php-email-form" accept-charset="utf-8" method="post" action="">
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  ...
                  <option value="Liso 1.35">Modelo Liso 1.35</option>
                  <option value="Liso con costuras">Modelo Liso con costuras</option>
                  <option value="Liso con costuras 1.35">Modelo Liso con costuras 1.35</option>
                  <option value="Liso con Orejas">Modelo Liso Con Orejas</option>
                  <option value="Liso con Orejas y tachas">Modelo Liso Con Orejas y Tachas</option>
                ...
                <div class="col-md-6" >
<div class="alert alert-info" role="alert" style="height: 15px; line-height: 1px;">
 Indicar tipo de botones aqui
</div>
...
<div class="col-md-6">
                  ...
                  <input type="text" name="rut" id="rut" class="form-control" placeholder="Rut" onkeydown="noPuntoComa(event)"  onkeyup="validarRut()" autocomplete="off" value="<?php echo $rut_cliente; ?>" required>
                   <p class="text-info"  id="msgerror" style="color:red !important;"></p><p class="text-info" id="msgvalido"></p>
...
<div class="form-group">
 ...
 <div class="col-md-6">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-3">
                  <div class="alert alert-info" role="alert" style="height: 15px; line-height: 1px;">
                  Indicar Si el respaldo esta pagado.
                  </div>
