...
<div class="modal fade" id="modalAceptarPedido" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form id="editarestado">    
            <div class="modal-body">
                ...
                <label for="id" class="col-form-label">Tapicero:</label>
                <input type="text" class="form-control" id="nombre_tapicero" readonly>
                </div>
                <div class="form-group col-md-4">
               
                <label for="id" class="col-form-label">Fecha:</label>
