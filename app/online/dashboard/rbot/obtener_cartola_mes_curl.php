<?php
include_once '../bd/conexion.php'; // Se mantiene si en algún otro flujo se requiera la conexión
$log = "log.txt";
...
if ($response) {
    ...
    if (isset($responseData['data'])) {
       ...
       //  $insertUrl = 'https://respaldoschile.cl/online/dashboard/rbot/insertar_datos.php';  // PRODUCCIÓN
        $insertUrl = 'http://localhost/respaldoschile/online/dashboard/rbot/insertar_datos.php';  // MODO PRUEBAS LOCALES.
