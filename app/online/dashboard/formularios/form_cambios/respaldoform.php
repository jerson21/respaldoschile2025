...
$nombre = $arow['nombre'];
 ...
 <div id="a" class="a" >
              ...
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  Seleccionar Modelo 
                  <select class="form-select" name="modelo_nuevo" aria-label="Default select example" required>
...
?>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-select" name="plazas_nuevo" aria-label="Default select example" required>
          ...
          <div class="alert alert-info" role="alert" style="height: 15px; line-height: 1px;">
           Tipo de botones 
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="boton_nuevo" id="diamante" value="B D">
                    <label class="form-check-label" for="flexRadioDefault1">
                      Botones Diamante
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="boton_nuevo" id="colores" value="B Color" checked>
                    <label class="form-check-label" for="flexRadioDefault2">
                      Botones de colores
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="boton_nuevo" id="normales" value="" checked>
                    <label class="form-check-label" for="flexRadioDefault2">
                      Botones Normales
                    </label>
                  </div>
