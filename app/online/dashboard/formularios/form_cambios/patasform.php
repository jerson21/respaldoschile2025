...
$instagram = $row['instagram'];
 ...
 ?>
              ...
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  Seleccionar Marca 
                  <select class="form-select" name="modelo_nuevo" aria-label="Default select example">
                ...
                <div class="col-md-7">
                  Ingresar cantidad 
                  <input type="text" name="cantidad" class="form-control"  style="max-width: 4rem;" data-mdb-showcounter="true" maxlength="3">
                </div>
